...
import unittest
import pandas as pd
from oguzhan_preprocessing import MissingValueHandler
...
class TestMissingValueHandler(unittest.TestCase):
    ...
    def test_impute_with_mean(self):
        ...
        print("test_impute_with_mean: ", expected_result)
    ...
    def test_impute_with_median(self):
        ...
        pd.testing.assert_frame_equal(df_result, expected_result)
        print("test_impute_with_median: ", expected_result)
    ...
    def test_impute_with_constant(self):
        ...
        pd.testing.assert_frame_equal(df_result, expected_result)
        print("test_impute_with_constant: ", expected_result)
    ...
    def test_drop_missing(self):
        ...
        pd.testing.assert_frame_equal(df_result, expected_result)
        print("test_drop_missing: ", expected_result)
