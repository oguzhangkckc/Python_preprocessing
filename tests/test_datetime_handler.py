...
import unittest
import pandas as pd
from oguzhan_preprocessing import DateTimeHandler
...
class TestDateTimeHandler(unittest.TestCase):
    ...
    def test_convert_to_datetime(self):
        ...
        print("test_convert_to_datetime: ", pd)
    ...
    def test_extract_date_parts(self):
        ...
        print("test_extract_date_parts: ", expected_result)
    ...
    def test_calculate_date_difference(self):
        ...
        pd.testing.assert_frame_equal(df_result, expected_result)
        print("test_calculate_date_difference: ", expected_result)
